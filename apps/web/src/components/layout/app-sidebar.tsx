...
const navItems = [
  ...
  { title: "Dedup Runs", href: "/runs", icon: Layers },
  { title: "Library", href: "/library", icon: Film },
  ...
  return (
    <Sidebar>
      ...
      <SidebarFooter className="border-t border-sidebar-border px-4 py-3">
        <a
          href="https://www.backblaze.com/cloud-storage?utm_source=github&utm_medium=referral&utm_campaign=ai_artifacts&utm_content=b2ai-videohash-dedup"
          target="_blank"
